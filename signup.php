...
$fname = $lname = $college = $id = $major = "";
$firstn_err = $lastn_err = $id_err = $college_err = $major_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["fname"]))){
        $firstn_err = "Please enter a first name";     
    } else{ 
    ...
    if(empty(trim($_POST["lname"]))){
        $lastn_err = "Please enter a last name";     
    } else{ 
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($firstn_err) && empty($lastn_err) && empty($college_err) && empty($major_err)){
        
        // Prepare an insert statement
        $sql = "INSERT INTO accounts (id, username, password,fname, lname, college, major) VALUES (:id, :username, :password, :fname, :lname, :college, :major)";
        ...
        if($stmt = $pdo->prepare($sql)){
            ...
            $stmt->bindParam(":college", $param_college, PDO::PARAM_STR);
    ...
    <div class="wrapper">
        ...
        <form name="form1" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="username" id = "txtEmail" class="form-control" value= "Please Enter Valid Email" value="<?php echo $username; ?>">
            ...
            <div class="form-group <?php echo (!empty($firstn_err)) ? 'has-error' : ''; ?>">
                <label>First Name</label>
                <input type="text" name="fname" class="form-control" value="<?php echo $fname; ?>">
                <span class="help-block"><?php echo $firstn_err; ?></span>
            </div>
            
            <div class="form-group <?php echo (!empty($lastn_err)) ? 'has-error' : ''; ?>">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn primary" value="Submit" onclick = "checkEmail()">
